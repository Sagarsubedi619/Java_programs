...
public class program {
    public static void main(String[] argv) {
        ...
        demo1.Solution(logs1);
    }

    public String[][] Solution(String[][] logArray){
        String[] nArr=new String[logArray.length];
        for(int i=0;i<logArray.length;i++){
            for(int j=1;j<logArray.length-1;j++){
                if(logArray[i][1]==logArray[j][1]){
                  nArr=logArray[i];
